Travis-CI status on Master Branch:  [![Build Status](https://travis-ci.org/ucsb-cs48-w19/4pm-gold-scheduler.svg?branch=testing)](https://travis-ci.org/ucsb-cs48-w19/4pm-gold-scheduler)
